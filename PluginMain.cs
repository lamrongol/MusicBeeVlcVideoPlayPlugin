    ...
    public partial class Plugin
    {
        ...
        public void ReceiveNotification(string sourceFileUrl, NotificationType type)
        {
            ...
            switch (type)
            {
                ...
                case NotificationType.PlayStateChanged:
                    ...
                    //https://getmusicbee.com/forum/index.php?topic=12419.msg209516#msg209516
                    //https://getmusicbee.com/forum/index.php?topic=12419.msg209539#msg209539
        ...
        public bool PlayVideo(string[] urls)
        {
            ...
            */
            ...
            //It's impossible to place the window on top only at first: https://forum.videolan.org/viewtopic.php?p=539302
